...
//
// Portal to portal warp setup. First arg is initiator area, second arg is destination area.
//
$Event(10006969, Restart, function(X0_4, X4_4) {
    DisableNetworkSync();
    WaitFor(PlayerIsInOwnWorld() && InArea(10000, X0_4));
...
L6:
    ...
    Goto(L19);
L7:
    WarpCharacterAndCopyFloor(10000, TargetEntityType.Area, X16_4, -1, 10000);
    Goto(L19);
L8:
    WarpCharacterAndCopyFloor(10000, TargetEntityType.Area, X20_4, -1, 10000);  
    Goto(L19);
L9:
    WarpCharacterAndCopyFloor(10000, TargetEntityType.Area, X24_4, -1, 10000);  
    Goto(L19);
L10:
    WarpCharacterAndCopyFloor(10000, TargetEntityType.Area, X28_4, -1, 10000);  
    Goto(L19);
L18: // on permadeath
    WaitFixedTimeSeconds(1);
    WarpCharacterAndCopyFloor(10000, TargetEntityType.Area, X4_4, -1, 10000);  
...
L0: // Team 1 Effect & Warp
    FadeToColor(1, 4.5, false, 0, 0.9,0.9,0.5);
    WaitFixedTimeSeconds(4.5);
    WarpCharacterAndCopyFloor(10000, TargetEntityType.Area, X0_4, -1, 10000);
    WaitFixedTimeSeconds(1);
    FadeToColor(0.3, 5, true, 0, 0.9,0.9,0.5);
    Goto(L2);
L1: // Team 2 Effect & Warp
    FadeToColor(1, 4.5, false, 0, 0.7,0.2,0.2);
    WaitFixedTimeSeconds(4.5);
    WarpCharacterAndCopyFloor(10000, TargetEntityType.Area, X4_4, -1, 10000);
    WaitFixedTimeSeconds(1);
    FadeToColor(0.3, 5, true, 0, 0.7,0.2,0.2);
    Goto(L2);
L2: 
